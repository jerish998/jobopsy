...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="nav navbar-nav navbar-center">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="Homepage.jsp"><i
							class="fa fa-fw fa-home"></i> HOME</a></li>
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="HomeServices.jsp"><i class='fas fa-cogs'></i>
							SERVICES</a></li>
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="HomeAbout.jsp"><i
							class='far fa-address-book'></i> ABOUT</a>
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="HomeTeam.jsp"><i class='fas fa-building'></i>
							TEAM</a></li>
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="HomeContact.jsp"><i
	...
	<section class="home" id="home">
		<div class="content" style="position: relative;">
			...
			<img
				src="zroller-brush-painting-worker-painting-surface-wall-painting-apartment-renovating-with-green-color-paint-1024x683.jpg"
				alt="Your Image" width="100%" height="700">
			<div
				style="position: absolute; top: 200px; left: 0; right: 0; bottom: 0; text-align: left; color: white;">
				<h3>
					HOME PAINTING <br> <span>Up To 50% Off</span>
				</h3>
				<p>Providing the highest quality painting and most professional
					services.</p>
				<button id="shopnow"onclick="location.href='ulog.jsp'">Book Now</button>
			</div>
		</div>
	</section>
			...
			<div class="row">
					...
					<div class="card text-light text-center bg-white pb-2">
						<div class="card-body text-dark">
							<div class="img-area mb-4">
								<img alt="" class="img-fluid" src="zplumber.jpg">
							</div>
				...
				<div class="col-12 col-md-12 col-lg-4">
					<div class="card text-light text-center bg-white pb-2">
						<div class="card-body text-dark">
							<div class="img-area mb-4">
								<img alt="" class="img-fluid" src="zElectricians.jpg">
							</div>
							<h3 class="card-title">ELECTRICIANS</h3>
							<p class="lead"></p>
						</div>
					</div>
				</div>
				<div class="col-12 col-md-12 col-lg-4">
					<div class="card text-light text-center bg-white pb-2">
						<div class="card-body text-dark">
							<div class="img-area mb-4">
								<img alt="" class="img-fluid" src="zcurtain-cleaning.jpg">
							</div>
				...
				<div class="col-12 col-md-12 col-lg-4">
					<div class="card text-light text-center bg-white pb-2">
						<div class="card-body text-dark">
							<div class="img-area mb-4">
								<img alt="" class="img-fluid" src="zgardener.jpg">
							</div>
				...
				<div class="col-12 col-md-12 col-lg-4">
					<div class="card text-light text-center bg-white pb-2">
						<div class="card-body text-dark">
							<div class="img-area mb-4">
								<img alt="" class="img-fluid" src="zpainter.jpg">
							</div>
				...
				<div class="col-12 col-md-12 col-lg-4">
					<div class="card text-light text-center bg-white pb-2">
						<div class="card-body text-dark">
							<div class="img-area mb-4">
								<img alt="" class="img-fluid" src="zfloor-care.avif">
							</div>
