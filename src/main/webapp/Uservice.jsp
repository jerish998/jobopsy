    ...
    <div class="row">
      <div class="col-12 col-md-12 col-lg-4">
        <div class="card text-light text-center bg-white pb-2">
          <div class="card-body text-dark">
            ...
            <button type="hidden" class="btn btn-sm btn-outline-warning" name="action" id="action" value="plumber" ><img src=zplumber.jpg height="280" width="280"></button>
        ...
        <div class="card text-light text-center bg-white pb-2">
          <div class="card-body text-dark">
            <div class="img-area mb-4"></div>
            <h3 class="card-title">CARPENTER</h3>
             <form action="Controller" method="post">
            <button type="hidden" class="btn btn-sm btn-outline-warning" name="action" id="action" value="carpenter" ><img src=zistockphoto-1325447575-170667a.jpg height="280" width="280"></button>
        ...
        <div class="card text-light text-center bg-white pb-2">
          <div class="card-body text-dark">
            ...
            <h3 class="card-title">ELECTRICIAN</h3>
             <form action="Controller" method="post">
           <button type="hidden" class="btn btn-sm btn-outline-warning" name="action" id="action" value="electrician" ><img src=zElectricians.jpg height="280" width="280"></button>
      ...
      <br>
        ...
        <div class="card text-light text-center bg-white pb-2">
          <div class="card-body text-dark">
            <div class="img-area mb-4"></div>
            <h3 class="card-title">PAINTER</h3>
             <form action="Controller" method="post">
            <button type="hidden" class="btn btn-sm btn-outline-warning" name="action" id="action" value="painter" ><img src=zpainter.jpg height="280" width="280"></button>
              <input type="hidden" name="service" value="painter">
             </form> 
          </div>
        </div>
      </div>
        ...
        <div class="card text-light text-center bg-white pb-2">
          <div class="card-body text-dark">
            ...
            <h3 class="card-title">FLOOR CLEANING</h3>
              <form action="Controller" method="post">
              <button type="hidden" class="btn btn-sm btn-outline-warning" name="action" id="action" value="floor cleaning" ><img src=zfloor-care.avif height="280" width="280"></button>
               <input type="hidden" name="service" value="floor cleaning">
               </form>   
          </div>
        </div>
      </div>
        ...
        <div class="card text-light text-center bg-white pb-2">
          <div class="card-body text-dark">
            ...
            <form action="Controller" method="post">
             <button type="hidden" class="btn btn-sm btn-outline-warning" name="action" id="action" value="house cleaning" ><img src=zcurtain-cleaning.jpg height="280" width="280"></button>
              <input type="hidden" name="service" value="house cleaning">             
            </form>
          </div>
        </div>
      </div>
